...
\begin{frame}[c]
	\frametitle{Horario de Clases (Tercer Periodo)}
	\begin{small}
	\begin{center}
    ...
    15:30 - 16:30  &       &         &           &         &         \\ \hline
    16:30 - 17:30  &       &         &           &         &         \\ \hline
	17:30 - 18:30  &       & Aula 13 &           & Aula 13 &         \\ \hline
    18:30 - 19:30  &       & Aula 13 &           & Aula 13 &         \\ \hline
    \hline
	\end{tabular}
	\end{center}
	\end{small}
...
\begin{frame}[c]
	\frametitle{Horario de Clases (Cuarto Periodo)}
	\begin{small}
	\begin{center}
	\begin{tabular}{||l|c|c|c|c|c||}
	\hline \hline
				   & Lunes & Martes  & Miércoles & Jueves  & Viernes \\ \hline \hline
    15:30 - 16:30  &       & Aula 13 &           & Aula 13 &         \\ \hline
    16:30 - 17:30  &       & Aula 13 &           & Aula 13 &         \\ \hline
	17:30 - 18:30  &       &         &           &         &         \\ \hline
    18:30 - 19:30  &       &         &           &         &         \\ \hline
    \hline
	\end{tabular}
...
\begin{frame}[c]
   ...
   \begin{enumerate}[<+->]
        ...
        \item Ser capaz de utilizar servicios proporcionados por los servidores de aplicaciones.
	\end{enumerate}
\end{frame}
...
\begin{frame}[c]
   ...
   \begin{enumerate}[<+->]
        ...
        \item Usar Spring para la construcción de capas de persistencia.
        \item Definir una interfaz REST para la manipulación de modelos de dominio.
        \item Serializar objetos en formato JSON usando anotaciones.
        \item Implementar una controlador HTTP usando Spring.
        \item Implementar una capa de servicio usando POJOS.
...
\begin{frame}[c]
	...
	\begin{block}{Fórmula de Cálculo de la Calificación Final}
		\begin{align*}
			Calificaci\acute{o}n\  Final  = \   & Proyecto \times 0.75 + \\
...
\begin{frame}[c]
    ...
    E7 & Implementación de la capa de presentación & 40\% \\ 
    \hline \hline
	\end{tabular}
    \end{center}
\end{frame}
